...
from util.utils import NestedTensor, nested_tensor_from_tensor_list
...
class INTR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs, encoder_output, attention_scores, avg_attention_scores = self.transformer(self.input_proj(src), mask,
